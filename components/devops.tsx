...
export function OrbitingCirclesDemo() {
  return (
    <div className="relative flex h-[400px] w-[400px] flex-col items-center justify-center overflow-hidden rounded-xl  bg-background shadow-xl dark:shadow-[#0f0f2a] border border-black/10">
